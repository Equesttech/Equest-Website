...
from classroom.forms import UserForm, TeacherProfileForm, StudentProfileForm, MarksForm, MessageForm, NoticeForm, \
    AssignmentForm, SubmitForm, TeacherProfileUpdateForm, StudentProfileUpdateForm, SignUpChoice
